/**
 * Body Scan Progress Header - Forge Corporelle (GPU-Optimized)
      ...
      <div className="forge-pipeline-card forge-pipeline-card--body">
        ...
        <div className="forge-header-row">
          <div className="forge-header-content">
            ...
            <div className="forge-icon-container forge-icon-container--body">
              <SpatialIcon
                Icon={ICONS.Scan}
                size={68}
                variant="pure"
            ...
            <div className="forge-title-container">
              <h2 className="forge-title forge-title--body">
                {currentStepData.title}
              </h2>
              <p className="forge-subtitle forge-subtitle--body">
          ...
          {/* Dynamic Step Badge */}
          <div className="forge-step-badge forge-step-badge--body">
        ...
        <div className="forge-progress-section">
          <div className="forge-progress-label-row">
            ...
            <span className="forge-progress-percentage forge-progress-percentage--body">
        ...
        <div className="forge-steps-grid">
          {steps.map((step, index) => {
            ...
            if (isCompleted) {
              ...
              iconBoxClass += ' forge-step-icon-box--active forge-step-icon-box--body';
            } else {
            ...
            if (isCompleted) {
              ...
              labelClass += ' forge-step-label--active forge-step-label--body';
            } else {
            ...
            return (
              <div key={step.id} className={itemClass}>
                ...
                <div className={iconBoxClass}>
                  ...
                  {isActive && (
                    <div className="forge-step-pulse-ring forge-step-pulse-ring--body" />
                  )}
                </div>
        ...
        {message && (
          <div className="forge-message-section forge-message-section--body">
            <div className="forge-message-content">
              <div className="forge-message-title forge-message-title--body">
                {message}
              </div>
              {subMessage && (
                <div className="forge-message-subtitle forge-message-subtitle--body">
                  {subMessage}
                </div>
              )}
            </div>
