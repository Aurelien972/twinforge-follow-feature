  ...
  const analysisModules = [
    {
      ...
      sublabel: 'Détection traits et proportions',
      color: '#18E3FF',
      activeThreshold: 10
    },
    {
      icon: 'Target' as const,
      label: 'Matching Sémantique',
      sublabel: 'Identification caractéristiques uniques',
      color: '#06B6D4',
      activeThreshold: 40
    },
    {
      icon: 'Smile' as const,
      label: 'Avatar Facial 3D',
      sublabel: 'Construction reflet numérique',
      color: '#22D3EE',
      activeThreshold: 70
    }
  ];
