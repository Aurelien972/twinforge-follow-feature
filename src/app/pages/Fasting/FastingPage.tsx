...
/**
 * FastingPage - Forge du Temps
 * Page de suivi du jeûne intermittent
 */
const FastingPage: React.FC = () => {
  const config = PLACEHOLDER_PAGES_CONFIG.fasting;
  ...
  return (
    ...
    >
      ...
      <Tabs defaultValue={config.tabs[0].value} className="w-full fasting-tabs">
        <Tabs.List role="tablist" aria-label="Sections de la Forge du Temps" className="mb-6 w-full">
          {config.tabs.map((tab) => (
