...
import MessagesDisplay from '../coach/MessagesDisplay';
            ...
            <div className="drawer-content flex-1 overflow-hidden flex flex-col">
              ...
              {!showReadyPrompt && (
                <div className="chat-interface-wrapper" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', position: 'relative', minHeight: 0 }}>
                  {isTextMode ? (
                    /* Mode Texte : Interface complète avec input intégré */
                    <CoachChatInterface
                      stepColor={modeColor}
                    ...
                    /* Mode Vocal : Messages + Input séparé si transcription active */
                    <>
                      {showTranscript && (
                        <>
                          <MessagesDisplay
                          ...
                          {/* Input texte pour le mode vocal avec transcription */}
                          <div className="voice-text-input-footer flex-shrink-0" style={{
                      ...
                      {/* Transcription en cours (visible en overlay) */}
                      {currentTranscription && (
                        ...
                        >
                          <motion.div
                            ...
                            className="inline-block px-4 py-2 rounded-2xl max-w-full bg-white/10 text-white"
                            style={{
                      ...
                      {/* Message vide en mode vocal sans transcription */}
                      {!showTranscript && (
                        <div className="flex flex-col items-center justify-center flex-1 text-center py-4">
                          ...
                          >
                            ...
                            <p className="text-xs text-white/50 mt-2">
                              Activez la transcription pour voir vos messages
                            </p>
                          </motion.div>
                        </div>
                      )}
