    ...
    switch (mode) {
      ...
      case 'balanced':
        return {
          ...
          features: [
            { label: 'Animations essentielles', enabled: true },
            { label: 'Effets de verre légers', enabled: true },
            { label: 'Transitions fluides', enabled: true },
            { label: 'Particules limitées', enabled: false },
            { label: 'Bonne performance', enabled: true },
            { label: 'Design soigné', enabled: true },
            { label: 'Expérience agréable', enabled: true },
            { label: 'Batterie raisonnable', enabled: true },
          ],
