import{r as d,j as e}from"./vendor-DX97-qL9.js";import{G as n}from"./ui-components-DWjWyKd7.js";import{H as p}from"./page-fridge-BvAjnJpI.js";import{m as s,A as m}from"./motion-DLE-fuXv.js";import"./utils-CUtLAp28.js";import"./supabase-C_rF2iqf.js";import"./page-fridge-scan-ZLPWYd6x.js";import"./stores-DcNfcD_j.js";import"./date-utils-sCOX3Ksr.js";const c=[{id:"logo-1",name:"Forge Hammer T",description:"T massif et imposant comme un marteau de forge avec étincelles",theme:"Puissance brute",style:"Industriel moderne",svg:`<svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
      <defs>
    ...
    </svg>`},{id:"logo-2",name:"Anvil T",description:"T intégré dans une enclume de forge stylisée",theme:"Solidité et forge",style:"Emblème classique",svg:`<svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
      <defs>
    ...
    </svg>`},{id:"logo-3",name:"Fire T",description:"T massif enflammé avec puissant effet de feu de forge",theme:"Intensité du feu",style:"Dynamique énergétique",svg:`<svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
      <defs>
    ...
    </svg>`},{id:"logo-4",name:"Metal T Shield",description:"T dans un bouclier métallique avec effet forgé",theme:"Protection et force",style:"Héraldique moderne",svg:`<svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
      <defs>
    ...
    </svg>`},{id:"logo-5",name:"Dual Ingot T",description:"T formé par deux lingots métalliques jumeaux",theme:"Dualité et forge",style:"Minimaliste premium",svg:`<svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
      <defs>
    ...
    </svg>`},{id:"logo-6",name:"Geometric Forge T",description:"T avec formes géométriques évoquant une forge moderne",theme:"Modernité technique",style:"Géométrique tech",svg:`<svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
      <defs>
    ...
    </svg>`},{id:"logo-7",name:"Molten T",description:"T liquide comme du métal en fusion",theme:"Transformation fluide",style:"Organique dynamique",svg:`<svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
      <defs>
    ...
    </svg>`},{id:"logo-8",name:"Rune Forge T",description:"T nordique avec runes et style viking forge",theme:"Héritage nordique",style:"Rune mystique",svg:`<svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
      <defs>
    ...
    </svg>`},{id:"logo-9",name:"Circuit T",description:"T avec circuits électriques, forge technologique",theme:"Tech et performance",style:"Cyber forge",svg:`<svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
      <defs>
    ...
    </svg>`},{id:"logo-10",name:"Crystalline T",description:"T massif cristallisé comme du métal refroidi et solidifié",theme:"Structure moléculaire",style:"Cristal premium",svg:`<svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg">
      <defs>
    ...
    </svg>`}];function b(){const[i,y]=d.useState(null),[o,f]=d.useState("grid"),r=t=>{y(t),p.success(),localStorage.setItem("selectedLogo",t)},l=c.find(t=>t.id===i);return e.jsxs("div",{className:"min-h-screen p-6 md:p-12",style:{background:"linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%)"},children:[e.jsxs("div",{className:"max-w-7xl mx-auto mb-12",children:[e.jsxs(s.div,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},className:"text-center mb-8",children:[e.jsxs("h1",{className:"text-5xl md:text-6xl font-bold text-white mb-4",children:["TWIN",e.jsx("span",{className:"text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-red-500 to-orange-400",children:"FØRGE"})]}),e.jsx("p",{className:"text-xl text-white/70 mb-2",children:"Sélection du Logo Définitif"}),e.jsx("p",{className:"text-sm text-white/50 max-w-2xl mx-auto",children:"Choisissez le logo qui représentera au mieux l'esprit de la forge et la dualité de votre application de training"})]}),e.jsxs("div",{className:"flex justify-center gap-4 mb-8",children:[e.jsx("button",{onClick:()=>f("grid"),className:`px-6 py-3 rounded-xl font-semibold transition-all ${o==="grid"?"bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-lg shadow-orange-500/50":"bg-white/10 text-white/70 hover:bg-white/20"}`,children:"Vue Galerie"}),e.jsx("button",{onClick:()=>f("showcase"),className:`px-6 py-3 rounded-xl font-semibold transition-all ${o==="showcase"?"bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-lg shadow-orange-500/50":"bg-white/10 text-white/70 hover:bg-white/20"}`,children:"Vue Détaillée"})]})]}),e.jsxs(m,{mode:"wait",children:[o==="grid"&&e.jsx(s.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"max-w-7xl mx-auto",children:e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12",children:c.map((t,a)=>e.jsx(s.div,{initial:{opacity:0,scale:.9,y:20},animate:{opacity:1,scale:1,y:0},transition:{delay:a*.05},children:e.jsxs(n,{className:`p-6 cursor-pointer transition-all duration-300 ${i===t.id?"ring-4 ring-orange-500 shadow-2xl shadow-orange-500/50":"hover:scale-105 hover:shadow-xl"}`,onClick:()=>r(t.id),children:[e.jsx("div",{className:"bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-xl p-6 mb-4 flex items-center justify-center",style:{minHeight:"120px"},dangerouslySetInnerHTML:{__html:t.svg}}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("h3",{className:"text-lg font-bold text-white",children:t.name}),e.jsx("p",{className:"text-sm text-white/60",children:t.description}),e.jsxs("div",{className:"flex gap-2 pt-2",children:[e.jsx("span",{className:"px-2 py-1 rounded-lg text-xs font-semibold bg-orange-500/20 text-orange-300",children:t.theme}),e.jsx("span",{className:"px-2 py-1 rounded-lg text-xs font-semibold bg-blue-500/20 text-blue-300",children:t.style})]}),i===t.id&&e.jsx(s.div,{initial:{opacity:0,y:5},animate:{opacity:1,y:0},className:"mt-3 pt-3 border-t border-white/10",children:e.jsxs("div",{className:"flex items-center gap-2 text-green-400",children:[e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 20 20",children:e.jsx("path",{fillRule:"evenodd",d:"M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z",clipRule:"evenodd"})}),e.jsx("span",{className:"text-sm font-semibold",children:"Logo sélectionné"})]})})]})]})},t.id))})},"grid"),o==="showcase"&&e.jsx(s.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"max-w-5xl mx-auto",children:e.jsx("div",{className:"space-y-8",children:c.map((t,a)=>e.jsx(s.div,{initial:{opacity:0,x:-50},animate:{opacity:1,x:0},transition:{delay:a*.08},children:e.jsx(n,{className:`p-8 cursor-pointer transition-all duration-300 ${i===t.id?"ring-4 ring-orange-500 shadow-2xl shadow-orange-500/50":"hover:scale-102 hover:shadow-xl"}`,onClick:()=>r(t.id),children:e.jsxs("div",{className:"flex flex-col md:flex-row gap-8 items-center",children:[e.jsx("div",{className:"flex-shrink-0 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl p-8 flex items-center justify-center",style:{width:"300px",height:"150px"},dangerouslySetInnerHTML:{__html:t.svg}}),e.jsxs("div",{className:"flex-1 space-y-4",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[e.jsx("h2",{className:"text-2xl font-bold text-white",children:t.name}),i===t.id&&e.jsx(s.span,{initial:{scale:0},animate:{scale:1},className:"px-3 py-1 rounded-full text-xs font-bold bg-green-500 text-white",children:"✓ CHOISI"})]}),e.jsx("p",{className:"text-base text-white/70",children:t.description})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-white/50 mb-1",children:"Thème"}),e.jsx("p",{className:"text-sm font-semibold text-orange-400",children:t.theme})]}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-white/50 mb-1",children:"Style"}),e.jsx("p",{className:"text-sm font-semibold text-blue-400",children:t.style})]})]}),e.jsx("button",{onClick:x=>{x.stopPropagation(),r(t.id)},className:`w-full py-3 rounded-xl font-semibold transition-all ${i===t.id?"bg-green-500 text-white":"bg-gradient-to-r from-orange-500 to-red-500 text-white hover:shadow-lg hover:shadow-orange-500/50"}`,children:i===t.id?"Logo Sélectionné":"Choisir ce Logo"})]})]})})},t.id))})},"showcase")]}),i&&e.jsx(s.div,{initial:{opacity:0,y:50},animate:{opacity:1,y:0},className:"fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50",children:e.jsx(n,{className:"px-8 py-4 shadow-2xl shadow-orange-500/30",children:e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"w-16 h-8",dangerouslySetInnerHTML:{__html:l?.svg||""}}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-white/70",children:"Logo sélectionné"}),e.jsx("p",{className:"font-bold text-white",children:l?.name})]}),e.jsx("button",{onClick:()=>{alert(`Logo "${l?.name}" sauvegardé! Il sera appliqué au prochain rechargement.`),p.success()},className:"ml-4 px-6 py-2 rounded-lg bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold hover:shadow-lg hover:shadow-green-500/50 transition-all",children:"Confirmer le choix"})]})})})]})}export{b as default};
